...
public final class InetMessagingAddress implements MessagingAddress, java.io.Externalizable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -4737779345905622694L;
	...
	private void init() {
		...
		Runnable r = new Runnable() {
			public void run() {
				...
				Thread.currentThread().setName("Resolving hostname for " + inetAddr.getHostAddress());
		...
		MessagingFactory.daemonThreadPool.execute(r);
	}

...
public interface MessagingProvider {
	...
	/**
	 * Returns a MessageReceiver bound to the port numbered 'port'.
	 */
	MessageReceiver getReceiver(MessagingConfiguration config, int port) throws IOException;
	...
	/**
	 * Sets the thread pool to this provider.
	 */
	ExecutorService setThreadPool(ExecutorService execService);
}

...
public class MessagingConfiguration {
	...
	public final static long DEFAULT_UPNP_TIMEOUT = 90 * 1000L;
	public final static boolean DEFAULT_DO_TIMEOUT_CALCULATION = true;
	public final static int DEFAULT_TIMEOUT_MIN = 2 * 1000;
	public final static int DEFAULT_TIMEOUT_MAX = 120 * 1000;
	public final static int DEFAULT_RTT_KEEPING_PERIOD = 5;
	public final static int DEFAULT_STATIC_TIMEOUT = 50 * 1000;

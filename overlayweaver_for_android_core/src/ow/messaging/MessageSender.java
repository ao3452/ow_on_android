...
public interface MessageSender {
	...
	SocketChannel sendAndCommunicate(MessagingAddress dest, Message msg) throws IOException;
	SocketChannel sendAndSockGet(MessagingAddress dest,Message msg )throws IOException;
	boolean sendData(SocketChannel sock ,MessagingAddress dest, Message msg)throws IOException;

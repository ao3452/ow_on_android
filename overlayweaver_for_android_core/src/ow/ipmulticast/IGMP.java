...
public final class IGMP {
	...
	// constants
	public static final int IGMP_MEMBERSHIP_QUERY		= 0x11;	// membership query
	public static final int IGMP_V1_MEMBERSHIP_REPORT	= 0x12;	// Ver. 1 membership report
	public static final int IGMP_V2_MEMBERSHIP_REPORT	= 0x16;	// Ver. 2 membership report
	public static final int IGMP_V3_MEMBERSHIP_REPORT	= 0x22;	// Ver. 3 membership report
	public static final int IGMP_V2_LEAVE_GROUP			= 0x17;	// Leave-group message

	public static final int IGMP_DVMRP					= 0x13;	// DVMRP routing message
	public static final int IGMP_PIM					= 0x14;	// PIM routing message
	public static final int IGMP_TRACE					= 0x15;

	public static final int IGMP_MTRACE_RESP			= 0x1e;	// traceroute resp.(to sender)
	public static final int IGMP_MTRACE					= 0x1f;	// mcast traceroute messages

...
public final class IGMPDaemonConfiguration {
	public static final boolean DEFAULT_KEEP_BEING_QUERIER = true;
	public static final int DEFAULT_UPDATE_INTERVAL = 5000;			// in units of 1/1000 sec

	public static final int DEFAULT_INITIAL_ROBUSTNESS_VARIABLE = 2;
	public static final int DEFAULT_INITIAL_QUERY_INTERVAL = 125;	// in sec
	public static final int DEFAULT_QUERY_RESPONSE_INTERVAL = 100;	// in units of 1/10 sec

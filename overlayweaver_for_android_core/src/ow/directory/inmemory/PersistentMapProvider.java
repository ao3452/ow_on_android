...
public final class PersistentMapProvider extends DirectoryProvider {
	...
	public <K,V> SingleValueDirectory<K,V> openSingleValueDirectory(Class typeK, Class typeV, String dir, String dbName) throws Exception {
		return new SingleValueHashDirectory<K,V>(typeK, typeV, dir, dbName, getBackupFilename(dbName), SYNC_INTERVAL);
	}
	...
	public <K,V> MultiValueDirectory<K,V> openMultiValueDirectory(Class typeK, Class typeV, String dir, String dbName) throws Exception {
		return new MultipleValueHashDirectory<K,V>(typeK, typeV, dir, dbName, getBackupFilename(dbName), SYNC_INTERVAL);
	}

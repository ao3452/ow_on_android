...
public interface MultiValueDirectory<K,V> extends Iterable<Map.Entry<K,V>> {
	/**
	 * Return a set of values associated to the specified key.
	 *
	...
	/**
	 * Put a pair of the specified key and value.
	...
	/**
	 * Remove a pair of the specified key and value.
	 *
	...
	/**
	 * Remove all values associated to the specified key.
	 *
	...
	/**
	 * Return true if this Directory instance is in-memory.
	 */
	boolean isInMemory();
}

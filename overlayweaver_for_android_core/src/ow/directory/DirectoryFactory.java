...
public class DirectoryFactory {
	...
	private final static Class/*<DirectoryProvider>*/[] PROVIDERS = {
		...
		ow.directory.hashmap.PersistentMapProvider.class,		// "PersistentMap"
		ow.directory.hashmap.VolatileMapProvider.class			// "VolatileMap"
	};

	private static final HashMap<String,DirectoryProvider> providerTable;

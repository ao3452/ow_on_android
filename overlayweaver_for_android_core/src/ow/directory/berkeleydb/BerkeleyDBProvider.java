...
public class BerkeleyDBProvider extends DirectoryProvider {
	...
	public <K,V> SingleValueDirectory<K,V> openSingleValueDirectory(Class typeK, Class typeV, String workingDir, String dbName) throws Exception {
		init();
	...
	public <K,V> MultiValueDirectory<K,V> openMultiValueDirectory(Class typeK, Class typeV, String workingDir, String dbName) throws Exception {
		init();

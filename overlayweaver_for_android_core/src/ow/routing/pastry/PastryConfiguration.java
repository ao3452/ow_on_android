...
public final class PastryConfiguration extends PlaxtonConfiguration {
	...
	private static final boolean DEFAULT_USE_LEAF_SET = true;
	private static final int DEFAULT_LEAF_SET_ONE_SIDE_SIZE = 4;
	private static final boolean DEFAULT_DO_PERIODIC_ROUTING_TABLE_MAINTENANCE = true;
	private static final long DEFAULT_ROUTING_TABLE_MAINTENANCE_INTERVAL = 30 * 1000L;
	private static final double DEFAULT_ROUTING_TABLE_MAINTENANCE_INTERVAL_PLAY_RATIO = 0.5;

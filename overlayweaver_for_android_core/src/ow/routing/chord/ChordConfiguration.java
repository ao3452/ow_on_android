...
/**
 * An instance of this class holds a configuration for Chord.
 */
public final class ChordConfiguration extends LinearWalkerConfiguration {
	public static final boolean DEFAULT_DO_FIX_FINGERS = true;
	public static final long DEFAULT_FIX_FINGERS_MIN_INTERVAL = 30 * 1000L;
	public static final long DEFAULT_FIX_FINGERS_MAX_INTERVAL = 240 * 1000L;
	public static final double DEFAULT_FIX_FINGERS_INTERVAL_PLAY_RATIO = 0.3;
	public static final double DEFAULT_PROB_PROPORTIONAL_TO_ID_SPACE = 0.7;

...
public class RecursiveRoutingDriverProvider extends AbstractRoutingDriverProvider {
	private final static String RUNTIME_NAME = "Recursive";
	...
	public RoutingService getService(
			...
			ID selfID)
				throws IOException {
		return new RecursiveRoutingDriver(config, provider, receiver, provider.getThreadPool(),

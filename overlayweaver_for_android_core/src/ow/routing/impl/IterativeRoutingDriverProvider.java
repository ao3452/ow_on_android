...
public class IterativeRoutingDriverProvider extends AbstractRoutingDriverProvider {
	...
	public RoutingService getService(
			...
			ID selfID)
				throws IOException {
		return new IterativeRoutingDriver(config, provider, receiver, provider.getThreadPool(),

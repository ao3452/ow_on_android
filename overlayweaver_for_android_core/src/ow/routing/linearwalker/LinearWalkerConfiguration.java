...
public class LinearWalkerConfiguration extends RoutingAlgorithmConfiguration {
	public static final int DEFAULT_SUCCESSOR_LIST_LENGTH = 8;	// infinity if the value <= 0
	public static final boolean DEFAULT_AGGRESSIVE_JOINING_MODE = false;
	public static final boolean DEFAULT_UPDATE_ROUTING_TABLE_BY_ALL_COMMUNICATIONS = false;

	public static final long DEFAULT_STABILIZE_MIN_INTERVAL = 250L;
	public static final long DEFAULT_STABILIZE_MAX_INTERVAL = 64 * 1000L;
	public static final double DEFAULT_STABILIZE_INTERVAL_PLAY_RATIO = 0.3;
	public static final int DEFAULT_UPDATE_PREDECESSOR_FREQ = 10;

	protected LinearWalkerConfiguration() {}

	/**
	 * Whether if a routing driver adjusts the result of routing by calling
	 * {@link RoutingAlgorithm#adjustRoot(ID) RoutingAlgorithm#adjustLastHop()}.
	 * This properties should be true for {@link ow.routing.chord.Chord Chord}.
	 */
	public boolean adjustRoot() { return true; }
